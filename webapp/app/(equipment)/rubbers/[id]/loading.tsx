      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="bg-white rounded-lg shadow-md border border-gray-200 overflow-hidden">
            <div className="px-6 py-4 border-b border-gray-200">
              <div className="animate-pulse">
                <div className="h-6 bg-gray-200 rounded w-1/4 mb-2 skeleton-shimmer"></div>
                  ...
                  <div key={index} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                    <div className="animate-pulse">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <div className="h-4 bg-gray-200 rounded w-24 mb-1 skeleton-shimmer"></div>
                          <div className="h-3 bg-gray-200 rounded w-16 skeleton-shimmer"></div>
                        </div>
                      </div>
                    </div>
                    <div className="animate-pulse">
                      <div className="h-5 bg-gray-200 rounded w-12 skeleton-shimmer"></div>
                    </div>
                  </div>
                ))}
              </div>
